      ...
      <div class="media_and_content">
        <div>
          <div class="media_wrap">
            ...
            <div class="img_wrap">
              <img width="1105" height="622" :src="imageSrc" :alt="title" loading="lazy">
            </div>
            <a href="#" class="go_down"></a>
          </div>
...
.Min-concept .media_and_content .entry_content_wrap,
